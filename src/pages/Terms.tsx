  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Read VocabQuests' terms of service, subscription terms, and privacy policy for our reading comprehension and test prep platform for Australian students. Children's privacy protections included."
        path="/terms"
      />
