              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                {learnGames.map((game) => (
                  <Button
                    ...
                    onClick={() => onStartGame && onStartGame(game.gameType, currentUnit.id, currentUnit.title.toLowerCase().startsWith('unit') ? currentUnit.title : `Unit ${currentUnit.unitNumber}: ${currentUnit.title}`)}
                  >
                    {game.isCompleted && (
                  ...
                  <GameCard
                    ...
                    onPlay={() => {
                      if (!game.isLocked && onStartGame && currentUnit) {
                        ...
                        onStartGame(game.gameType, currentUnit.id, currentUnit.title.toLowerCase().startsWith('unit') ? currentUnit.title : `Unit ${currentUnit.unitNumber}: ${currentUnit.title}`, playAllWordsOnStart);
